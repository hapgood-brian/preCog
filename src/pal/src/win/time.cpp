...
//Functions:{                                     |
  //e_seconds:{                                   |
    ...
    double e_seconds(){
      alignas( 16 )LARGE_INTEGER i, f;
      QueryPerformanceFrequency( &f );
      QueryPerformanceCounter( &i );
      return double( i.QuadPart / f.QuadPart );
    }

  //}:                                            |
  //e_milliseconds:{                              |

    double e_milliseconds(){
      double sec = e_seconds();
      return sec*1000.;
    }
  ...
  //e_microseconds:{                              |
    ...
    double e_microseconds(){
      double ms = e_milliseconds();
      return ms*1000.;
    }
  ...
  //e_nanoseconds:{                               |
    ...
    double e_nanoseconds(){
      double us = e_microseconds();
      return us*1000.;
    }
